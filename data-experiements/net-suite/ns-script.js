...
const ORDER_DATA_PATH = '../xml/sales_order_record.xml'

const orderRaw = await (await fetch(ORDER_DATA_PATH)).text();
const orderXML = new DOMParser().parseFromString(orderRaw,'application/xml')
const orderDoc  =orderXML.documentElement
console.log('orderXML.documentElement', orderXML.documentElement)
